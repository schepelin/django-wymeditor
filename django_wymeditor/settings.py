# Django settings for django_wymeditor project.
...
SECRET_KEY = '8puo1vk%815p(52u!ks4ca%x@h!^ook2+63n2gr#9up@&amp;o1cdf'
...
ROOT_URLCONF = 'django_wymeditor.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'django_wymeditor.wsgi.application'
